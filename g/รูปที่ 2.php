...
<?php
	...
	$sql = "SELECT * 'FROM popsupermarket' WHERE p_country =         'Sweden' AND p_categoy = 'Vegetables'ORDER BY p_product_name ASC";
...
<tr>
   ...
   <td><img src="<?php echo $data['p_product_name'];?>.jpg"width ="55">
   </td>
</tr> 
<?php }?>
