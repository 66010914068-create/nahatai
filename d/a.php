...
<head>
    ...
    <title>ณหทัย โกสิลา (ออม) - แบบฟอร์มสมัครสมาชิก</title>
        ...
        <div class="col-lg-8 col-md-10">
            ...
            <div class="card shadow-lg border-0 rounded-4">
                <div class="card-header bg-white text-center py-4 rounded-top-4 border-bottom-0">
                    ...
                    <p class="text-secondary mb-0">ณหทัย โกสิลา (ออม)</p>
                </div>
...
<div class="row justify-content-center">
    <div class="col-lg-12">
        <h3 class="text-white mb-4"><i class="bi bi-person-badge-fill me-2"></i> ข้อมูลการสมัคร (Application List)</h3>
        ...
        <div class="table-responsive bg-white p-3 rounded-4 shadow">
            <table class="table table-hover">
                ...
                <tbody>
                    ...
                    $sql_select = "SELECT * FROM register ORDER BY r_id DESC";
                    ...
                    while($row = mysqli_fetch_assoc($result)) {
                        ...
                        echo "<td>".$row['r_height']." ซม.</td>";
                        echo "<td>".$row['r_major']."</td>";
                        echo "<td><div style='width:25px; height:25px; border-radius:50%; background-color:".$row['r_color']."; border:1px solid #ccc;'></div></td>";
                        echo "</tr>";
                    }
                    ?>
                </tbody>
